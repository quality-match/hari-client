...
init_attribute_media_1_id = str(uuid.uuid4())  # Boolean values
init_attribute_media_2_id = str(uuid.uuid4())  # String values
init_attribute_media_3_id = str(uuid.uuid4())  # Numeric values
init_attribute_object_1_id = str(uuid.uuid4())  # Boolean values
init_attribute_object_2_id = str(uuid.uuid4())  # String values
init_attribute_object_3_id = str(uuid.uuid4())  # Numeric values
...
media_1.add_attribute(
    hari_uploader.HARIAttribute(
        id=init_attribute_media_3_id,
        name="initMediaAttributeSlid",
...
media_object_1.add_attribute(
    hari_uploader.HARIAttribute(
        id=init_attribute_object_2_id,
        name="initObjectAttributeCat",
        attribute_type=models.AttributeType.Categorical,
        value="string3",
    )
)
...
new_subset_id = hari.create_subset(
    ...
    subset_name="All media objects 1",
)
