...
class PipelineProject(pydantic.BaseModel):
    pipeline_project_ids: list[str] | None = pydantic.Field(
        default=None,
        title="Pipeline Project Ids",
        description="List of project IDs associated with the pipeline",
    )
    pipeline_id: str | None = pydantic.Field(
        default=None, title="Pipeline Id", description="Identifier for the pipeline"
    )
    revision_id: str | None = pydantic.Field(
        default=None,
        title="Revision Id",
        description="Revision identifier for the pipeline configuration",
    )
    goliat_id: str | None = pydantic.Field(
        default=None,
        title="Goliat Id",
        description="External or internal reference ID for the pipeline",
    )
