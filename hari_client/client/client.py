...
class HARIClient:
    ...
    def get_medias(
        ...
        # if projection:
        #     params.update(projection)  # <-- flatten projection keys like "projection[id]": True, otherwise it will not work
    ...
    def get_media_objects(
        ...
        # if projection:
        #     params.update(
        #         projection)  # <-- flatten projection keys like "projection[id]": True, otherwise it will not work
