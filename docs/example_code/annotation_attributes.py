...
media_1 = hari_uploader.HARIMedia(
    ...
    file_path="/Users/benjaminbentner/repos/hari-client/docs/example_code/images/image_2.jpg",
...
attribute_object_1 = hari_uploader.HARIAttribute(
    ...
    frequency={"one": 90, "two": 5, "three": 3},
    cant_solves=2,
...
attribute_object_2 = hari_uploader.HARIAttribute(
    ...
    repeats=100,
    possible_values=["one", "two", "three"],
    frequency={"one": 100, "two": 0, "three": 0},
    cant_solves=0,
...
attribute_object_3 = hari_uploader.HARIAttribute(
    id=annotation_attribute_id,
    name="human being uploaded attribute categorical?",
    attribute_type=models.AttributeType.Categorical,
    attribute_group=models.AttributeGroup.AnnotationAttribute,
...
media_object_3.add_attribute(attribute_object_3)
media_1.add_media_object(media_object_3)

attribute_object_4 = hari_uploader.HARIAttribute(
    id=annotation_attribute_id,
    name="human being uploaded attribute categorical?",
    attribute_type=models.AttributeType.Categorical,
    attribute_group=models.AttributeGroup.AnnotationAttribute,
    ...
    repeats=100,
    possible_values=["one", "two", "three"],
    frequency={"one": 20, "two": 20, "three": 20},
    cant_solves=40,

)

media_object_4.add_attribute(attribute_object_4)
media_1.add_media_object(media_object_4)

attribute_object_5 = hari_uploader.HARIAttribute(
    id=annotation_attribute_id,
    name="human being uploaded attribute categorical?",
    attribute_type=models.AttributeType.Categorical,
    attribute_group=models.AttributeGroup.AnnotationAttribute,
    ...
    repeats=100,
    possible_values=["one", "two", "three"],
    frequency={"one": 10, "two": 80, "three": 10},
    cant_solves=0,

)

media_object_5.add_attribute(attribute_object_5)
media_1.add_media_object(media_object_5)
...
media_1.add_media_object(media_object_6)

attribute_object_7 = hari_uploader.HARIAttribute(
    id=annotation_attribute_id,
    name="human being uploaded attribute categorical?",
    attribute_type=models.AttributeType.Categorical,
    attribute_group=models.AttributeGroup.AnnotationAttribute,
...
media_object_7.add_attribute(attribute_object_7)
media_1.add_media_object(media_object_7)

attribute_object_8 = hari_uploader.HARIAttribute(
    id=annotation_attribute_id,
    name="human being uploaded attribute categorical?",
    attribute_type=models.AttributeType.Categorical,
    attribute_group=models.AttributeGroup.AnnotationAttribute,
...
media_object_8.add_attribute(attribute_object_8)
media_1.add_media_object(media_object_8)

attribute_object_9 = hari_uploader.HARIAttribute(
    id=annotation_attribute_id,
    name="human being uploaded attribute categorical?",
    attribute_type=models.AttributeType.Categorical,
    attribute_group=models.AttributeGroup.AnnotationAttribute,
...
media_object_9.add_attribute(attribute_object_9)
media_1.add_media_object(media_object_9)

attribute_object_10 = hari_uploader.HARIAttribute(
    id=annotation_attribute_id,
    name="human being uploaded attribute categorical?",
    attribute_type=models.AttributeType.Categorical,
    attribute_group=models.AttributeGroup.AnnotationAttribute,
...
media_object_10.add_attribute(attribute_object_10)
media_1.add_media_object(media_object_10)
