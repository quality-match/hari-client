...
DATASET_ID = uuid.UUID("2f57b8f1-7d73-42bf-b003-2fb518437352")  # 0.5s
DATASET_ID = uuid.UUID("49a5c33b-8cc5-4fc2-93e2-1102482a5fc7")  # 10s
labels = [
    "close_to_road",
    "crossing",
    "waiting_to_cross",
...
labels = [
    "bent_ego_road",
    "no_turn",
    "turning_left_crossing_different_road",
    "turning_left_different_reason",
    "turning_left_roundabout",
    "cant_solve",
]
question = "Is car turning left?"
AINT_NAME = "AINT - Turning Left"
