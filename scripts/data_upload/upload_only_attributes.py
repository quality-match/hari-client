...
if __name__ == "__main__":
    ...
    media = hari_uploader.ReferencedMedia(
        back_reference=media.back_reference,
        media_type=models.MediaType.IMAGE,
    )

    # if media object is uploaded already only the backreference is needed
    obj1 = hari_uploader.ReferencedMediaObject(back_reference=obj1.back_reference)

    # Add attributes to the media
    att3 = hari_uploader.HARIAttribute(
        id=uuid.uuid4(),
        name="Attribute4",
    ...
    att4 = hari_uploader.HARIAttribute(
        id=uuid.uuid4(),
        name="Attribute4",
        attribute_group=models.AttributeGroup.AnnotationAttribute,
        attribute_type=models.AttributeType.Categorical,
